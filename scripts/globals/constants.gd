...
const WIN_SCREEN_SCENE_PATH: String = "res://scenes/ui/components/win_screen.tscn"
const DEFEAT_SCREEN_SCENE_PATH: String = "res://scenes/ui/components/defeat_screen.tscn"
